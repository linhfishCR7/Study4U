    ...
    <asp:Panel ID="panelPhanQuyen" runat="server">
                ...
                <asp:UpdatePanel ID="upCrudGrid" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="GridView1" runat="server" Width="100%" HorizontalAlign="Center" OnRowCommand="GridView1_RowCommand"
                            ...
                            DataKeyNames="ID_Truong" CssClass="table table-striped table-responsive table-hover table-bordered dt-responsive nowrap" Style="border-collapse: collapse; border-spacing: 0; width: 100%;" DataSourceID="SqlDataSource1">
                            <Columns>
                                ...
                                <asp:BoundField DataField="HinhAnhBanner" HeaderText="HinhAnhBanner" SortExpression="HinhAnhBanner" />
                        ...
                        <ContentTemplate>
                            <div class="modal-body">
                                <table class="table table-responsive ">
                                    ...
                                    <tr>
                                        <td>Banner-Picture Url: </td>
                                        <td>
                                            <div class="input-group">
                                                <asp:TextBox ID="txtHinhAnhBanner" runat="server" CssClass="form-control"></asp:TextBox>
                                                <span class="input-group-btn">
                            ...
                            <div class="modal-body">
                                <table class="table table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <asp:TextBox ID="txtHinhAnhBanner1" runat="server" CssClass="form-control"></asp:TextBox>
                                                <span class="input-group-btn">
        ...
        <div>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                ...
                InsertCommand="INSERT INTO [tbl04_TruongHoc] ([TenTruong], [HinhAnh], [HinhAnhBanner], [MoTa], [NoiDung], [ID_CT]) VALUES (@TenTruong, @HinhAnh, @HinhAnhBanner, @MoTa, @NoiDung, @ID_CT)"
                UpdateCommand="UPDATE [tbl04_TruongHoc] SET [TenTruong] = @TenTruong, [HinhAnh] = @HinhAnh, [HinhAnhBanner] = @HinhAnhBanner, [MoTa] = @MoTa, [NoiDung] = @NoiDung, [ID_CT] = @ID_CT WHERE [ID_Truong] = @ID_Truong">
                <DeleteParameters>
                ...
                <InsertParameters>
                    ...
                    <asp:Parameter Name="HinhAnhBanner" Type="String" />
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:Study4UConnectionString %>" SelectCommand="SELECT * FROM [tbl02_ChuongTrinh]"></asp:SqlDataSource>
